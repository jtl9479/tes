...
public interface ReservationMapper {
	...
	void chargeFee(int fee, int m_no);

	void getFee(int fee, String fm_id);

	String getFmId(int finfo_no);
	...
	String selectRefundFmId(int reser_no);

	void chargeRefundFee(int refundFee, String fm_id);

	int selectRefundM_no(int reser_no);

	void getRefundFee(int m_no, int refundFee);
