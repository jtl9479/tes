...
<!--   <script type="text/javascript">
  	function facButton(){
		...
		var files = [];
        $('input[name="files"]').each(function(i){//자리 배열
            chairList.push($(this).val());
        });
                ...
                <div id="fac_inform_input1">
                  <form action="fac_register" method="post" enctype="multipart/form-data">
                    <div class="form-group" id="fac_input">
                      ...
                      <input type="text" class="form-control" id="fm_id" name="fm_id" placeholder="시설 관리자 아이디" value = "${session_id }" readonly="readonly">
                      ...
                      <div class="custom-file">
                        ...
                        <label class="custom-file-label" for="customFile1">파일 업로드</label>
                      </div>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile2" name="files">
                        <label class="custom-file-label" for="customFile2">파일 업로드</label>
                      </div>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile3" name="files">
                        <label class="custom-file-label" for="customFile3">파일 업로드</label>
                      </div>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile4" name="files">
                        <label class="custom-file-label" for="customFile4">파일 업로드</label>
                      </div>
                      <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile5" name="files">
                        <label class="custom-file-label" for="customFile5">파일 업로드</label>
                      </div>
