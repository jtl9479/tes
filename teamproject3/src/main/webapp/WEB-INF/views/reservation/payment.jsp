					...
					<div class = "info_outline">
						...
						<div class = "info_table">
							...
							<colgroup width="80%">
								...
								<tr>
									<td class = "info_td">결제포인트</td>
									<td class = "info_text_td">${map.pVo.pay_price }p</td>
								</tr>
								<c:if test="${map.pVo.pay_status == '1' }">
									<tr>
									...
									<tr>
										<td class = "info_td">환불 포인트</td>
										<td class = "info_text_td"><span class = "refund_span">${map.refundVo.refund_price }</span>p</td>
									</tr>
								</c:if>
							</table>
						</div>
