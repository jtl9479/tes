    ...
    <form action="modify" name="modify" method="post">
      ...
      <input type="hidden" name="bid" value="${map.listVo.bid}">
        ...
        <tr>
          <th>작성자</th>
          <td>
            <input type="text" name="bname" value="${map.listVo.bname}" readonly>
          </td>
        </tr>
        <tr>
          <th>제목</th>
          <td>
            <input type="text" name="btitle" value="${map.listVo.btitle }">
          </td>
        </tr>
        <tr>
          <th>내용</th>
          <td>
            <textarea name="bcontent" cols="50" rows="10">${map.listVo.bcontent}
            </textarea>
          </td>
        </tr>
        <tr>
